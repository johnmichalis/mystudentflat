...
function HomePage(){
  const{navigate,cities,flats}=useContext(AppContext);const[ci,setCi]=useState(0);const[heroSearch,setHeroSearch]=useState('');const[showCities,setShowCities]=useState(false);const cn=["Nicosia","Athens","Limassol"];
