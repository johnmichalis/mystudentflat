...
export default function App(){
  ...
  return(<ErrorBoundary><AppContext.Provider value={ctx}>
    <style>{`*,*::before,*::after{box-sizing:border-box;margin:0}body{margin:0;overflow-x:hidden}::selection{background:${P};color:white}@keyframes pulse{0%,100%{opacity:1}50%{opacity:0.4}}@keyframes fadeSlide{0%{opacity:0;transform:translateY(12px)}100%{opacity:1;transform:translateY(0)}}@keyframes slideIn{from{transform:translateX(100px);opacity:0}to{transform:translateX(0);opacity:1}}@media(max-width:768px){.hero-grid,.detail-grid,.invest-grid{grid-template-columns:1fr!important}.hero-img{display:none!important}.nav-desktop{display:none!important}.nav-mobile-btn{display:block!important}.listings-grid{grid-template-columns:1fr!important}.form-grid{grid-template-columns:1fr!important}.details-grid{grid-template-columns:1fr 1fr!important}.listings-map-grid{grid-template-columns:1fr!important}.listings-map-col{display:none!important}section{padding:60px 16px!important}.booking-card{position:relative!important;top:auto!important}.hero-section{padding:120px 16px 60px!important}}@media(max-width:480px){.details-grid{grid-template-columns:1fr!important}.steps-grid{grid-template-columns:1fr!important}.stats-grid{grid-template-columns:1fr 1fr!important}.cities-grid{grid-template-columns:1fr 1fr!important}.reviews-grid{grid-template-columns:1fr!important}}@media(min-width:769px){.nav-mobile-btn{display:none!important}}`}</style>
